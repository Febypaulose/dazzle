<div id="secondary" class="widget-area col-xs-12 col-md-3">
                ...
                $colours =  DB::table('products')
                                      ...
                                      ->where('productscategories.subcategoryId','=',16)

                                      ->orwhere('productscategories.subcategoryId','=',17)

                                      ->orwhere('productscategories.subcategoryId','=',20)
                ...
                @if($segment == 'deals' || $segment == 'womenproducts' || $segment == 'childproducts')
                ...
                @endif
                    ...
                    <ul class="product-categories">
                      ...
                      @endphp
                      @if($segment == 'womenproducts' && $category->category =='Women' )
                      <li>
                        <a href="#" title="{{$category->category}}">{{$category->category}}</a>
                        @if(!empty($subcategory) && $category->category == 'Kids' && $segment =='childproducts'  )
                              <ul class="children">
                      ...
                      @elseif($segment == 'childproducts' && $category->category =='Kids')
                      <li>
                        <a href="#" title="{{$category->category}}">{{$category->category}}</a>
                        @if(!empty($subcategory) && $category->category == 'Kids' && $segment =='childproducts'  )
                              <ul class="children">
                ...
                <aside class="widget widget_color_option">
                    ...
                    <ul>
                        ...
                        @php $serachkeycol = 'id='.$color->id.'&type=color'; @endphp
