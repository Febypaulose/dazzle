                    ...
                    <div class="item-inner">
                        ...
                        <div class="product">
                            ...
                            <p class="listpricecurrent">{!! Helper::getdiscountamt($product->Id,$product->product_price) !!}</p>
                             ...
                             <!--<p class="product-price listpricediscount" style="margin-left: -81px;margin-top: 9px;display:none">{!! Helper::getdiscountamt($product->Id,$product->product_price) !!}</p>-->

                             <!--<p class="listpricecurrent" style="margin-top: 62px;margin-left: 204px;text-decoration: line-through;display:none">{!! Helper::currency_conversion($product->product_price) !!}</p>-->
